  ...
  return (
    ...
    >
      <div className={"max-w-[400px] bg-inherit shadow flex flex-col my-4 p-6"}>
        ...
        <p className={"pb-2"}>
          האתר נועד לעזור ולאתר את הנעדרים של מלחמת חרבות ברזל האתר נבנה ללא
          מטרות רווח והוא פתוח לשימוש חופשי
        </p>
        <p className={"pb-2"}>
          האתר נבנה בפרויקט קוד פתוח וכל המידע בו מוזן על ידי מתנדבים
        </p>
