...
const faqs = [
  ...
  },
  {
    ...
    answer: "שלחו לנו מייל על ידי הכפתור הכחול",
  },
  {
    ...
    <div className="" dir="rtl">
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8 lg:py-40">
        <div className="mx-auto max-w-4xl divide-y divide-gray-900/10">
          <h2 className="text-4xl font-bold leading-10 tracking-tight text-black dark:invert">
            שאלות נפוצות
          </h2>
                ...
                {({ open }) => (
                  <>
                    ...
                    <Disclosure.Panel as="dd" className="mt-2 pr-12">
                      <p className="text-base leading-7 text-black dark:invert">
                        {faq.answer}
                      </p>
                    </Disclosure.Panel>
                  </>
          ...
          <SendEmailToAdminButton>
            <Button
              className={
                "w-full sm:w-20 sm:text-center bg-blue-800 text-white font-bold text-sm uppercase rounded hover:bg-blue-700 flex items-center justify-center px-2 py-3 mt-4"
              }
            >
              צור קשר
            </Button>
